...
{
	const char	*className = typeid(*this).name();
	std::cout << F_R_GRN << ++className << " " << F_R_PRPL << getName() << F_R_GRN << " attack " << F_R_PRPL << target << F_R_GRN << ", causing " << F_R_PRPL << m_hitpoints << F_R_GRN << " points of damage!" << RESET << std::endl;
}
